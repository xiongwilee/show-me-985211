(function() {
    ...
    var $schoolMsg = document.getElementById('schoolMsg');
    $schoolName.addEventListener('keyup', function() {
        if (list.some(function(item) { return $schoolName.value.indexOf(item) > -1; })) {
            $schoolMsg.innerHTML = '<b class="green">YES!</b>';
        } else {
            $schoolMsg.innerHTML = '<b class="red">NO!</b>';
        }
    });
})();